 ...
 String lsub;
  ...
  String lbal;
    public print(String sub,String pay,String bal , TableModel tablemodel) throws PrinterException {
        ...
        txtprint.setText(txtprint.getText()+"********************Pharmacy*******************\n");
        txtprint.setText(txtprint.getText()+"\n");
        ...
        txtprint.setText(txtprint.getText()+ product +  "\t"+ price +  "\t" + total);
            ...
            txtprint.setText(txtprint.getText()+"\n");
            txtprint.setText(txtprint.getText()+"\n");
             txtprint.setText(txtprint.getText()+"                 " + "SubToatal:" +sub+           "\n");
             txtprint.setText(txtprint.getText()+"                 " + "SubToatal:" +pay+           "\n");
             txtprint.setText(txtprint.getText()+"                 " + "SubToatal:" +bal+           "\n");
             txtprint.setText(txtprint.getText()+"***************************************************\n");
